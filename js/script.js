$(document).ready(function () {
    ...
    if (isMobile) {
      var myScroll = new IScroll('#features-container',
                      {
    ...
    new ScrollMagic.Scene({
      ...
      reverse: false
        ...
        .setClassToggle('#feature-1-image', 'fadeInLeftBig')
        .addTo(controller);
    ...
    new ScrollMagic.Scene({
      ...
      reverse: false
        ...
        .setClassToggle('#feature-2-image', 'fadeInRightBig')
        .addTo(controller);
   ...
   //Transition 2 text
    ...
    new ScrollMagic.Scene({
      ...
      reverse: false
        ...
        .setClassToggle('#feature-3-image', 'fadeInLeftBig')
        .addTo(controller);
